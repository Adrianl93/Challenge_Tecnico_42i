    ...
    <div className="overlay" >
        <div className="modalContent">
            <div>
                ...
                { results  ? <h4 className='results'>The minimal Non contructible change is: {results}</h4> : resultsH2 && <h4 className='results'>Sorry,The minimal Non contructible change is 1 </h4>}
            </div>
            </div>
